...
function patchFooter(html) {
  var alreadyIcons =
    html.indexOf('class="footer-social"') !== -1 &&
    /class="footer-social"[\s\S]*?<svg[\s\S]*?<\/p>/.test(html);
  if (alreadyIcons) return html;
  ...
  var block =
    '<p class="footer-social" style="margin:0.75rem 0;display:flex;justify-content:center;align-items:center;gap:1.25rem;flex-wrap:wrap;">' +
